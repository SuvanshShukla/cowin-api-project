...
export default function AboutModal() {
  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
      <h2 id="simple-modal-title">About This Website</h2>
  ...
  return (
    <div>
        {/* had to turn this into an article tag to make the look match better with the drawer styling */}
      <article type="button" onClick={handleOpen}>
        About This Website
      </article>
      <Modal
        open={open}
